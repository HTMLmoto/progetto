            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <?php if (isset($_SESSION['id'])) { ?>
                        <li class="nav-item">
                            <a class="nav-link text-info" href="logout.php"><i class="fa fa-sign-out"></i> Logout</a>
                        </li>
                    <?php } else { ?>
                        <li class="nav-item">
                            <a class="nav-link text-danger" href="login.php"><i class="fa fa-sign-in"></i> Login</a>
                        </li>
                    <?php } ?>
                </ul>
            </div>
